...
public class Config {
    ...
    public static void loadConfig() throws FileNotFoundException, IOException, ParserConfigurationException, SAXException {
        CONFIG_FILE = "config" + FILE_SEPARATOR + "config.xml";
        loadConfigFile("", CONFIG_FILE);
        CONEXION_STRING = "jdbc:mysql://" + DB_HOST + "/" + DB_NAME;
    }
    
    public static void loadConfig(String path) throws FileNotFoundException, IOException, ParserConfigurationException, SAXException {
        CONFIG_FILE = path;
        loadConfigFile("", CONFIG_FILE);
        CONEXION_STRING = "jdbc:mysql://" + DB_HOST + "/" + DB_NAME;
    }
